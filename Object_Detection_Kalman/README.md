...
Para el desarrollo de este sistema se utilizó Python 3.12, SORT de código abierto, deep-sort-realtime y el modelo yolov8l de ultralytics. Para el manual general de ejecución, se puede observar el proyecto de [HMI_DSP](HMI_DSP) (Interfaz de procesamiento digital de señales); sin embargo, en este apartado se explicará el desempeño del sistema y los fundamentos técnicos.
